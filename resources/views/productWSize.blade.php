...
<div class="d-flex flex-md-row flex-column" id="productCont">
    ...
    <div class="order-md-2 col-md-5 pl-5" id="column2">
        ...
        <div class="order-1">
            <h5><strong>Adidas Golf 360 Traxion</strong></h5>
            <div class="row d-none d-md-flex">
                <div class="col-7 actualPrice">
                    <strong>S/ 150,57</strong>
                </div>
        ...
        <div class="order-3">
            ...
            <div class="container mt-3">
                <div class="row pb-2">
                    <h6><strong>Color: </strong> Negro</h6>
                </div>
                <div class="row">
                    <div class="col-12 col-md p-0 pl-md-3">
                        <button class="btn btn-block btn-outline-warning rounded-0">
                            <div class="row">
                                <div class="col-10 col-md-12">
                                    <div class="row justify-content-md-center justify-content-start align-items-center">
                                        <img src="{{URL::asset('img/2ndTypeWeb.png')}}" class="d-none d-md-block">
                                        <img src="{{URL::asset('img/2ndTypeMovil.png')}}" class="d-md-none pl-3">
                    ...
                    <div class="col-md d-none d-md-inline p-0 pl-md-3">
                        <button class="btn btn-block btn-outline-secondary rounded-0">
                            <div class="row">
                                <div class="col-10 col-md-12">
                                    <div class="row justify-content-center align-items-center">
                                        <img src="{{URL::asset('img/3rdTypeWeb.png')}}" class="d-none d-md-block">
                                        <span class="anthrMod"><strong>S/ 160.00</strong></span>
                                    </div>
                                </div>
                                <div class="col-2 align-self-center d-md-none">
                    ...
                    <div class="col-md d-none d-md-inline p-0 pl-md-3">
                        <button class="btn btn-block btn-outline-secondary rounded-0">
                            <div class="row">
                                <div class="col-10 col-md-12">
                                    <div class="row justify-content-center align-items-center">
                                        <img src="{{URL::asset('img/4thTypeWeb.png')}}" class="d-none d-md-block">
                                        <span class="anthrMod"><strong>S/ 160.00</strong></span>
                                    </div>
                                </div>
                                <div class="col-2 align-self-center d-md-none">
            ...
            <div class="container mt-3">
                <div class="row pb-2">
                    <h6><strong>Talla: </strong> <span class="text-primary">(Verifica tu talla)</span> </h6>
                </div>
                <div class="row pl-md-3 d-none d-md-block">
                    <button class="btn btn-outline-warning mr-2 rounded-0">6</button>
                    <button class="btn btn-outline-warning mr-2 rounded-0">7</button>
                    <button class="btn btn-outline-warning mr-2 rounded-0">8</button>
                    <button class="btn btn-outline-warning mr-2 rounded-0">9</button>
                    <button class="btn btn-outline-warning mr-2 rounded-0">10</button>
                    <button class="btn btn-outline-warning mr-2 rounded-0">11</button>
                    <button class="btn btn-outline-warning mr-2 rounded-0">12</button>
                </div>
                    ...
                    <div class="col-8 col-md-5">
                        <div class="input-group text-center">
                            ...
                            <div class="input-group-append" id="quantity">
                                <button class="btn btn-outline-warning rounded-0" type="button">-</button>
                                <button class="btn btn-outline-warning rounded-0" type="button">+</button>
                            </div>
                        </div>
                    </div>
